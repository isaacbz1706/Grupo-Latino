...
<body>
    ...
    <section id="fondoNegro">
        <!-- Promocion-->
        <div class="container">
            <p class="lead fw-normal text-white-50 mb-0"><img src="imagenes/PromoSumiF.png" alt="" id="promocion"></p>
        </div>
    </section>
        ...
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                <!-- 1 -->
                 ...
                 <?php
                                    $query = $conn->query("SELECT * from cat_sumi");
                    ...
                    <div class="card h-100" id="DetallesProductos">
                        ...
                        <div class="card-body p-4" id="DetallesProductos">
                            <div class="text-center">
                                ...
                                <p class="text-center"><img class="card-img-top" id="LogosCat" src="LOGOS/sumitomor.png" alt="" /></p>
                                <!-- Product price-->
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center">
                                <button type="button" class="btn btn" style="background-color: #00A9E9;" data-bs-toggle="modal"
    ...
    <!-- Footer-->
    <section id="footerSumitomo">
        <div class="container-fluid">
            <p id="PCOnti" class="m-0 text-center text-white"><b><i>COTIZA TUS LLANTAS SUMITOMO<img
                            src="LOGOS/sumitomo.png" width="70px" alt=""></i></b></p>
