                    ...
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <?php
                                    $get_id = $_GET['upd'];
                                    $query = $conn->query("select * from reclutamiento where id='$get_id'");
                                    ...
                                    <div class="col-lg-10 mx-auto" class="form-control" id="InputMod">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-white" id="basic-addon2"
                                                id="Modi">NOMBRE</span>
                                            <input type="text-dark" type="text" placeholder="Ingresa tu nombre"
                                        ...
                                        <div class="input-group input-group-lg" id="InputMod">
                                            <span class="input-group-text text-white" id="basic-addon2"
                                                ...
                                                placeholder="Ingresa tu numero celurar">PUESTO</span>
                                            <input type="text-dark" type="text" name="puesto" class="form-control"
                                                id="Modi" value="<?php echo $row['puesto']?>" readonly>
                                        </div>

                                        <div class="input-group input-group-lg" id="InputMod">
                                            <span class="input-group-text text-white" id="basic-addon2">EDAD</span>
                                            <input type="number" name="edad" placeholder="Ingresa tu edad"
                                                class="form-control" value="<?php echo $row['edad'] ?>">
                                        </div>

                                        <div class="input-group input-group-lg" id="InputMod">
                                            <span class="input-group-text text-white" id="basic-addon2">TELEFONO</span>
                                            <input type="text" name="telefono" placeholder="Ingresa tu numero celular"
                                                class="form-control" value="<?php echo $row['telefono'] ?>">
                                        </div>

                                        <div class="input-group input-group-lg" id="InputMod">
                                            <span class="input-group-text text-white" id="basic-addon2">E-MAIL</span>
                                        ...
                                        <a href="reclutamiento.php" class="btn btn-primary"><img src="iconos/back.png"
