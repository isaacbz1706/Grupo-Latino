                    ...
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <form action="add_reno.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-lg-10 mx-auto" class="form-control" id="InputMod">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="text-dark" type="text" placeholder="Ingresa el nombre"
                                                name="nombre" class="form-control" id="Modi" required>
                                        </div>
                                        <div class="input-group input-group-lg" id="InputMod">
                                            <span class="input-group-text text-white" id="basic-addon2"
                                                for="inputGroupSelect01">POSICIÓN</span>
                                            <input type="text-dark" placeholder="Ingresa la posición" type="text"
                                                name="posicion" class="form-control" id="Modi">
                                        </div>

                                        <div class="input-group input-group-lg" id="InputMod">
                                            <span class="input-group-text text-white"
                                                id="basic-addon2">PROFUNDIDAD</span>
                                            <input type="text" name="profundidad" placeholder="Ingrese la profundidad"
                                                class="form-control">
                                        </div>

                                        <div class="input-group input-group-lg" id="InputMod">
                                            <span class="input-group-text text-white" id="basic-addon2">SERVCIO</span>
                                            <input type="text" name="servicio" placeholder="Ingrese el servicio"
                                                class="form-control">
                                        </div>
                                        ...
                                        <div class="input-group input-group-lg" id="InputMod">
                                            ...
                                            placeholder="Ejemplo: Reno1" class="form-control">
                                        </div>
                                        ...
                                        <div class="input-group input-group-lg" id="InputMod">
                                            <span class="input-group-text text-white" id="basic-addon2">IMAGEN DEL RENOVADO</span>
                                            <input type="file" name="img_llanta" class="form-control" required>
