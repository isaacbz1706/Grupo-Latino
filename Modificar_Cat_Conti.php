                    ...
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <?php
                                    $get_id1 = $_GET['upd1'];
                                    $query = $conn->query("SELECT * FROM cat_conti WHERE id='$get_id1'");

                                    while($row = $query->fetch()){
                                    ?>
                                <form action="modificarConti.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-lg-10 mx-auto" class="form-control" id="InputMod">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-white" id="basic-addon2"
                                                id="Modi">NOMBRE</span>
                                            <input type="text-dark" type="text" name="nombre" class="form-control"
                                                id="Modi" value="<?php echo $row['nombre']?>">
                                        </div>
                                        ...
                                        <div class="input-group input-group-lg" id="InputMod">
                                            <span class="input-group-text text-white" id="basic-addon2">IMAGEN DEL
                                                MODAL</span>
                                            <input type="text" name="ImagenMod" class="form-control"
