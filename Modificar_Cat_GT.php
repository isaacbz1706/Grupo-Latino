                    ...
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <?php
                                    $get_id1 = $_GET['upd1'];
                                    $query = $conn->query("SELECT * FROM cat_gt WHERE id='$get_id1'");

                                    while($row = $query->fetch()){
                                    ?>
                                    <form action="modificarGT.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-lg-10 mx-auto" class="form-control" id="InputMod">
                                        ...
                                        <a href="CatalogoGT.php" class="btn btn-primary"><img src="iconos/back.png"
