                            ...
                            <table class="table table-bordered table-dark table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="Modificar_Cat_Sai.php?upd1=<?=$row['id'];?>" class="btn btn-warning"><img src="iconos/lapiz.png" width="25px"
                                                    alt=""></a>

                                            <a href="delete_sailun.php?id=<?php echo $row['id'];?>"
