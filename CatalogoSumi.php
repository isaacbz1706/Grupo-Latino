            ...
            <div class="col-lg-14">
                <div class="panel">
                    <div class="panel-body">
                        ...
                        <br>
                        <br>
                        <h3><b><i>Catalogo Sumitomo:</i></b></h3>
                            ...
                            <table class="table table-bordered table-dark table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="Modificar_Cat_Sumi.php?upd1=<?=$row['id'];?>" class="btn btn-warning"><img src="iconos/lapiz.png" width="25px"
                                                    alt=""></a>

                                            <a href="delete_sumitomo.php?id=<?php echo $row['id'];?>"
