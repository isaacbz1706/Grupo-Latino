...
<body>
    ...
    <section id="fondoNegro">
        <!-- Promocion-->
        <div class="container">
            <p class="lead fw-normal text-white-50 mb-0"><img src="imagenes/PromoLub.jpg" alt="" id="promocion"></p>
        </div>
    </section>
    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                <!-- 1 -->
                <?php
                                    $query = $conn->query("SELECT * from cat_sote");
                    ...
                    <div class="card h-100" id="DetallesProductos">
                        ...
                        <div class="card-body p-4" id="DetallesProductos">
                            <div class="text-center">
                                ...
                                <?php include('LogoSotera.php');?>                                <!-- Product price-->
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center">
                                <button type="button" style="background-color: #FA2321;" class="btn btn" data-bs-toggle="modal"
    ...
    <!-- Footer-->
    <section id="footerSotera">
        <div class="container-fluid">
            <p id="PCOnti" class="m-0 text-center text-white"><b><i>COTIZA TUS LLANTAS SOTERA<img
                            src="LOGOS/LogoSotera.png" width="70px" alt=""></i></b></p>
